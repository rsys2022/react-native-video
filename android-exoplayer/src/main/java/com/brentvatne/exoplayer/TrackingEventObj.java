...
public class TrackingEventObj {
    ...
    public String toString() {
        return "TrackingEventObj [beaconUrls=" + beaconUrls +  ", duration=" + duration + ", time=" + time + ", eventType=" + eventType + ", start=" + start + ", end=" + end + ", skipOffset=" + skipOffset + "]";
    }
}